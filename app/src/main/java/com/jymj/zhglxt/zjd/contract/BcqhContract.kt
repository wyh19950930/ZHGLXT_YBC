...
//        fun getCyfz(proId:String):String
    ...
    interface View:BaseView{
        ...
        fun returnBcqhUpload(msg: JtcyjcEntity)
        fun returnBcjcjtImportData(msg: String)
        fun returnBcqhDetail(msg: List<JtcyjcEntity>)
    ...
    companion object {
        abstract class Presenter:BasePresenter<View,BaseModel>(){
            ...
            abstract fun getBcqhUpload(jtcyjcEntity: JtcyjcEntity)
            abstract fun getBcjcjtImportData(code:String,years:String,years1:String)
            abstract fun getBcqhDetail(code:String,sorting:Int,id:Long)
