...
interface ZjdfjglContract {
    /*interface Model:BaseModel{
//        fun getCyfz(proId:String):String
    }*/
    interface View:BaseView{
        fun returnApplyByPoint(fjBean: ApplyEntity)
    ...
    companion object {
        abstract class Presenter:BasePresenter<View,BaseModel>(){
            ...
            abstract fun getSteps(lastSelect:Int,limit:Int,page:Int,cunCode:String,date:String,bh:String)
