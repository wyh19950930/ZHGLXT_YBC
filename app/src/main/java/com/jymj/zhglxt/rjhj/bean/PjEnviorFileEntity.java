...
public class PjEnviorFileEntity implements Serializable {
    private Integer id;
    private String name;
    private String path;
    private String url;
    ...
    public PjEnviorFileEntity(Integer id, String name, String path, Integer pid, String entime, Integer enpsn, String jlrname, String jlrtel, Integer filetype, String filetypeText, Integer msid) {
        this.id = id;
        this.name = name;
        this.path = path;
        this.entime = entime;
