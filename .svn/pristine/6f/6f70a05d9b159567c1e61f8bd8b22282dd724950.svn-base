...
public class HeritageScopeTileProvider1 extends UrlTileProvider {

    private String mRootUrl;
    //默认瓦片大小
    private static int titleSize = 256;//a=6378137±2（m）  256
    //基本参数
...
//    private final double originShift      = 20037508.342789244;//2*Math.PI*6378137/2.0; 周长的一半
    ...
    public HeritageScopeTileProvider1(String rootUrl) {
...
//        ALBUM_PATH=path;
    ...
    public HeritageScopeTileProvider1(int i, int i1) {
        super(i, i1);
    }
