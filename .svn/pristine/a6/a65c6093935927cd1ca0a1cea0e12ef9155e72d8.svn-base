...
public class TuLiColorVerticalLayout extends LinearLayout {
    private RecyclerView rlv_layout_tuli_color_list;
    private Context context;

    public TuLiColorVerticalLayout(Context context) {
        this(context,null);
    }
    public TuLiColorVerticalLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
        init(context);
        getValues(attrs);
    }
    public TuLiColorVerticalLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData(List<TuliColorBean> tuliColorBeans){//item_tuli_list_layout
        rlv_layout_tuli_color_list.setLayoutManager(new LinearLayoutManager(context,LinearLayoutManager.VERTICAL,false));
        rlv_layout_tuli_color_list.setAdapter(new BaseQuickAdapter<TuliColorBean,BaseViewHolder>(R.layout.item_tuli_list_vertical_layout,tuliColorBeans) {
            @Override
