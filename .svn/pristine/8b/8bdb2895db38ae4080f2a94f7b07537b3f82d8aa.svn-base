...
public class TDTTileProvider extends UrlTileProvider {
    public static final String NORMAL = "vec_w";
    public static final String NORMAL_NOTE = "cva_w";
    public static final String STA = "img_w";
    public static final String STA_NOTE = "cia_w";
     ...
     * @param path  缓存路径
     */
    public TDTTileProvider(String type, String path) {
        super(256, 256);//256
        this.type = type;
