...
public class WyFzRoomFicAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<HousingRoomFile> mList;
    private OnQyglFileLinear onClickLister;

    public WyFzRoomFicAdapter(Context context, List<HousingRoomFile> mList) {
    ...
    public void setmList(List<HousingRoomFile> mList) {
        this.mList = mList;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (position < mList.size()){
            HousingRoomFile enterpriseFileEntity = mList.get(position);
...
//                    onClickLister.onClick(enterpriseFileEntity,position);
    ...
    public interface OnQyglFileLinear{
        void onClick(HousingRoomFile enterpriseFileEntity, int position);
        void onDeleteClick(HousingRoomFile enterpriseFileEntity, int position);
    }
