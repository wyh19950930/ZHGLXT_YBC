...
public class ImageUtil {
    ...
    public static Bitmap drawTextToRightBottom(Context context, Bitmap bitmap, String text, int size, int color, int paddingRight, int paddingBottom) {
        Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setColor(color);
        Typeface font = Typeface.create(Typeface.SANS_SERIF, Typeface.BOLD);//Typeface.SANS_SERIF
//        Typeface typeface3 =Typeface.createFromAsset(context.getAssets(), "fonts/timesi.ttf");
