...
public class MeTitleWhiteLayout extends LinearLayout {
    ...
    public MeTitleWhiteLayout(Context context) {
        this(context,null);
    }
    public MeTitleWhiteLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
        init(context);
        getValues(attrs);
    }
    public MeTitleWhiteLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
