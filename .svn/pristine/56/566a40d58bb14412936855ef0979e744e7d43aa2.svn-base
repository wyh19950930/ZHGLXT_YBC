...
import kotlinx.android.synthetic.main.fragment_zjd_tdgh.*
 ...
 *
 */
class ZjdTdghFragment : BaseFragment<NyyqPresenter, BaseModel>(), NyyqContract.View{
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): ZjdTdghFragment {
            return ZjdTdghFragment().apply {
//                ToastUtils.showShort("${sectionNumber}")
    ...
    override fun getLayoutResource(): Int {
        return R.layout.fragment_zjd_tdgh
    }
    ...
    fun diaoyong(){
        if (supl_frag_zjdgl1!=null){
            supl_frag_zjdgl1?.setScrollableView(slv_frag_zjd_tdgh)
        }
    }
