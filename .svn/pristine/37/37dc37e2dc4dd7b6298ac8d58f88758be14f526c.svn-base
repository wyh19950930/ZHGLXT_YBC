...
public class BubbleRelativeLayout  extends RelativeLayout {
    ...
    public static int SHADOW_COLOR = Color.argb(100, 0, 0, 0);//Color.argb(100, 255, 0, 0);红
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.bubble1);

            try {
                PADDING = a.getDimensionPixelSize(R.styleable.bubble1_padding1, PADDING);
                SHADOW_COLOR = a.getInt(R.styleable.bubble1_shadowColor1, SHADOW_COLOR);
                LEG_HALF_BASE = a.getDimensionPixelSize(R.styleable.bubble1_halfBaseOfLeg1, LEG_HALF_BASE);
                MIN_LEG_DISTANCE = PADDING + LEG_HALF_BASE;
                STROKE_WIDTH = a.getFloat(R.styleable.bubble1_strokeWidth1, STROKE_WIDTH);
                CORNER_RADIUS = a.getFloat(R.styleable.bubble1_cornerRadius1, CORNER_RADIUS);
            } finally {
                if (a != null) {
                    a.recycle();
                }
        ...
        mFillPaint.setColor(Color.parseColor("#020202"));//Color.WHITE  Color.parseColor("#020202")  设置气泡颜色
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f, Color.parseColor("#020202"), Color.parseColor("#020202"), Shader.TileMode.CLAMP));
