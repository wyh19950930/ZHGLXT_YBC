 ...
 */
public class MoveCostLevel1 extends AbstractExpandableItem<MoveCostLevel2> implements MultiItemEntity, Comparable, Serializable {
    ...
    public int compareTo(Object o) {
        MoveCostLevel1 m = (MoveCostLevel1) o;
        int c = m.getCostId();
