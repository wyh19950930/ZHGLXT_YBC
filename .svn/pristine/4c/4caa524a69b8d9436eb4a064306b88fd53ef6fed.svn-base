...
public class MeTitleLayout2 extends LinearLayout {
    ...
    public MeTitleLayout2(Context context) {
        this(context,null);
    }
    public MeTitleLayout2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
        init(context);
        getValues(attrs);
    }
    public MeTitleLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        Log.i("", "init: ");
        ...
        View inflate = inflater.inflate(R.layout.layout_my_title_item2, this);
        ll_item_my_title_name = findViewById(R.id.ll_item_my_title_name2);
        tv_item_my_title_name = findViewById(R.id.tv_item_my_title_name2);//左侧名称
        tv_item_my_title_name_add = findViewById(R.id.tv_item_my_title_name_add2);//右侧按钮名称 与图标
        iv_item_my_title_name = findViewById(R.id.iv_item_my_title_name2);//右侧展开隐藏箭头
        view_item_my_title_name = findViewById(R.id.view_item_my_title_name2);//左侧方块
