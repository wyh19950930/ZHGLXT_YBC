...
public class DisplayUtil {
	 ...
	 * @return
	 */
	public static int  getMetricsFullHeight(Context context) {
		DisplayMetrics metrics = new DisplayMetrics();
	...
	public static int getWidth() {
		...
		return dip2px(330f);//width
	}

	public static int getHeight() {//这个只要用于关系图
		WindowManager wm = (WindowManager) BaseApplication.getAppContext().getSystemService(Context.WINDOW_SERVICE);
		int height = wm.getDefaultDisplay().getHeight();//height
		return dip2px(300f);
	}
